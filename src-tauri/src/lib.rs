...
pub fn run() {
    ...
    let app = tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            commands::history::agent_run_latest_checkpoint,
            commands::history::agent_run_close,
            ...
            commands::agent::agent_read_files,
            commands::agent::agent_search_files,
            commands::agent::agent_apply_patch,
            ...
            commands::agent::agent_cu_check_permission,
            commands::agent::agent_cu_screenshot,
            commands::agent::agent_cu_move,
            commands::agent::agent_cu_click,
            commands::agent::agent_cu_drag,
            commands::agent::agent_cu_scroll,
            commands::agent::agent_cu_type,
            commands::agent::agent_cu_key,
            commands::agent::agent_cu_cursor_position,
            ...
            commands::agent::rag_corpus_stale,
            commands::agent::rag_rebuild_hybrid_index,
